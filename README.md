# zencart-to-magento
=== Zen Cart to Magento 1.x Migration Tool ===
Version: 2.4.1
Developed by: LitExtension

Download: https://litextension.com/shopping-cart-migration/zencart-to-magento.html

== Description: Zen Cart to Magento 1.x Migration Tool allows you to migrate your products, orders, customers, passwords and other data from Zen Cart to Magento 1.x automatically.
